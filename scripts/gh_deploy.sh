...
echo "> api-auth build 파일명 : $AUTH_SERVER_JAR_NAME" >> $DEPLOY_LOG_PATH
echo "> application build 파일명 : $AUTH_SERVER_JAR_NAME" >> $DEPLOY_LOG_PATH
...
echo "> API_SERVER_DEPLOY_JAR 배포" >> $AUTH_SERVER_LOG_PATH
