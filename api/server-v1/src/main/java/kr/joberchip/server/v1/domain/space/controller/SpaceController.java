package kr.joberchip.server.v1.domain.space.controller;
...
import kr.joberchip.server.v1.domain.page.service.SharePageService;
import kr.joberchip.server.v1.domain.space.controller.dto.ParticipationInfoResponseDTO;
import kr.joberchip.server.v1.domain.space.controller.dto.SpaceInviteRequestDTO;
import kr.joberchip.server.v1.domain.space.service.SpaceParticipationInfoService;
import kr.joberchip.server.v1.global.security.CustomUserDetails;
import kr.joberchip.server.v1.global.utils.ApiResponse;
import kr.joberchip.server.v1.domain.space.service.SpaceInfoDTO;
import kr.joberchip.server.v1.domain.space.service.SpaceService;
